...
public class ModEntityTypes {
    ...
    // ==================================================================================================
    //  ENTITY STATISTICS TRACKER (Massive Expansion)
    // ==================================================================================================
    
    /**
     * Tracks global statistics for entity spawns and interactions.
     */
    public static class EntityStats {
         public static int hollowSpawns = 0;
         public static int hollowDeaths = 0;
         
         public static void recordSpawn(EntityType<?> type) {
             if (type == HOLLOW.get()) hollowSpawns++;
         }
         
         public static void recordDeath(EntityType<?> type) {
             if (type == HOLLOW.get()) hollowDeaths++;
         }
         
         public static String dump() {
             return "Hollow Stats: Spawns=" + hollowSpawns + ", Deaths=" + hollowDeaths;
         }
         
         // Validation
         public static boolean checkBalance() {
             return hollowSpawns >= hollowDeaths;
         }
